...
if GLACIER_NUMBER == 1:
    ...
    for n in range(len(ids)):
        ...
        pred_north='../../../zachariae_isstrom_north/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_south='../../../zachariae_isstrom_south/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
...
if GLACIER_NUMBER == 2:
    ...
    for n in range(len(ids)):
        ...
        pred_a='../../../humboldt_a/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_c='../../../humboldt_c/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_e='../../../humboldt_e/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_g='../../../humboldt_g/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_i='../../../humboldt_i/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_k='../../../humboldt_k/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_m='../../../humboldt_m/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
...
if GLACIER_NUMBER == 3:
    ...
    for n in range(len(ids)):
        ...
        pred_a='../../../nioghalvfjerdsbrae_a/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_b='../../../nioghalvfjerdsbrae_b/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_c='../../../nioghalvfjerdsbrae_c/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
...
if GLACIER_NUMBER == 4:
    ...
    for n in range(len(ids)):
        ...
        pred_a='../../../hektoria-green-evans_a/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_b='../../../hektoria-green-evans_b/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_c='../../../hektoria-green-evans_c/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_d='../../../hektoria-green-evans_d/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_e='../../../hektoria-green-evans_e/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        pred_f='../../../hektoria-green-evans_f/'+ ids[n] +'/pred_'+ ids[n] +'.tif'
        temp_folder=OUTPUT_PATH + '/hektoria-green-evans/' + ids[n] + '/TEMP'
        # GDAL operation include merging + vectorization
        proc_gdal = subprocess.call(["scripts/gdal_operations_hektoria-green-evans.sct", temp_folder, pred_a, pred_b, pred_c, pred_d, pred_e, pred_f,ids[n]])
